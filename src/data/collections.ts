export const collections = [
  {
    ...
    specifications: [
      { label: "Origin", value: "Global Prestige Quarries" },
      { label: "Applications", value: "Flooring, Countertops, Wall Cladding" },
      { label: "Finishes Available", value: "Polished, Honed, Brushed" },
  ...
  },
  {
    ...
    specifications: [
      { label: "Origin", value: "Global Prestige Quarries" },
      { label: "Applications", value: "Feature Walls, Bathrooms, Flooring" },
      { label: "Finishes Available", value: "Polished, Leathered" },
      { label: "Thickness", value: "20mm, 30mm" }
    ]
  },
  {
    ...
    specifications: [
      { label: "Origin", value: "Global Prestige Quarries" },
      { label: "Applications", value: "Tabletops, Decorative Paneling, Bathrooms" },
      { label: "Finishes Available", value: "Polished, Honed" },
  ...
  },
  {
    ...
    specifications: [
      { label: "Origin", value: "Global Prestige Quarries" },
      { label: "Applications", value: "Backlit Bars, Statement Walls, Custom Furniture" },
      { label: "Finishes Available", value: "Polished" },
      { label: "Thickness", value: "15mm, 20mm" }
    ]
  }
];
