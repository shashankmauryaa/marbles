...
export default function Footer() {
  return (
    <footer className="relative z-10 bg-stone-950 text-stone-400 font-sans pt-32 pb-12 px-6 md:px-12 lg:px-24">
